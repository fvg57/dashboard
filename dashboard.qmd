...
chr_2024<-chr_2024|>
  mutate(
    votes=floor(voter_turnout*county_population),
    rural_voters=floor(voter_turnout*county_population*rural_raw),
    female_voters=floor(voter_turnout*county_population*female_raw),
...
list(
  #icon = "clipboard2-pulse",
  color = "tertiary",
  value = label_percent(accuracy = 0.1)(floor(sum(chr_2024$rural_voters)/sum(chr_2024$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "orange",
  value = label_percent(accuracy = 0.1)(floor(sum(chr_2024$female_voters)/sum(chr_2024$county_population)))
)
```
...
overview_vote_table<-data.frame(
  ...
  state_turnout=c(il_turnout,in_turnout,mi_turnout,mn_turnout,oh_turnout,wi_turnout),
  state_proportion=c(sum(il_chr$votes)/sum(chr_2024$county_population),
                     sum(in_chr$votes)/sum(chr_2024$county_population),
                     sum(mi_chr$votes)/sum(chr_2024$county_population),
                     sum(mn_chr$votes)/sum(chr_2024$county_population),
                     sum(oh_chr$votes)/sum(chr_2024$county_population),
                     sum(wi_chr$votes)/sum(chr_2024$county_population)))
...
ggplot(data=urban_voting,aes(x=urban,y=votes))+
  geom_point(size=3,color="#8826b9")+
...
ggplot()+
  geom_point(data=il_chr,aes(x=rural_raw,y=votes,color="Illinois"))+
  geom_point(data=in_chr,aes(x=rural_raw,y=votes,color="Indiana"))+
  geom_point(data=mi_chr,aes(x=rural_raw,y=votes,color="Michigan"))+
  geom_point(data=mn_chr,aes(x=rural_raw,y=votes,color="Minnesota"))+
  geom_point(data=oh_chr,aes(x=rural_raw,y=votes,color="Ohio"))+
  geom_point(data=wi_chr,aes(x=rural_raw,y=votes,color="Wisconsin"))+
  labs(x="Percent Rural Population",y="Number of Votes")+
  xlim(0,100)+ylim(0,5000000)
```
...
ggplot()+
  geom_point(data=il_chr,aes(x=female_raw,y=votes,color="Illinois"))+
  geom_point(data=in_chr,aes(x=female_raw,y=votes,color="Indiana"))+
  geom_point(data=mi_chr,aes(x=female_raw,y=votes,color="Michigan"))+
  geom_point(data=mn_chr,aes(x=female_raw,y=votes,color="Minnesota"))+
  geom_point(data=oh_chr,aes(x=female_raw,y=votes,color="Ohio"))+
  geom_point(data=wi_chr,aes(x=female_raw,y=votes,color="Wisconsin"))+
  labs(x="Percent Female Population",y="Number of Votes")+
  xlim(35,65)+ylim(0,5000000)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "tertiary",
  value = label_percent(accuracy = 0.1)(floor(sum(il_chr$rural_voters)/sum(il_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "orange",
  value = label_percent(accuracy = 0.1)(floor(sum(il_chr$female_voters)/sum(il_chr$county_population)))
)
```
...
il_chr|>
  ...
  arrange(county)|>
  datatable(
    colnames=c("County Name","Percent Female Population","Percent Voter Turnout","Population",
...
list(
  #icon = "clipboard2-pulse",
  color = "tertiary",
  value = label_percent(accuracy = 0.1)(floor(sum(in_chr$rural_voters)/sum(in_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "orange",
  value = label_percent(accuracy = 0.1)(floor(sum(in_chr$female_voters)/sum(in_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "tertiary",
  value = label_percent(accuracy = 0.1)(floor(sum(mi_chr$rural_voters)/sum(mi_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "orange",
  value = label_percent(accuracy = 0.1)(floor(sum(mi_chr$female_voters)/sum(mi_chr$county_population)))
)
```
...
in_chr$urban<-factor(mi_chr$urban)
...
list(
  #icon = "clipboard2-pulse",
  color = "tertiary",
  value = label_percent(accuracy = 0.1)(floor(sum(mn_chr$rural_voters)/sum(mn_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "orange",
  value = label_percent(accuracy = 0.1)(floor(sum(mn_chr$female_voters)/sum(mn_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "tertiary",
  value = label_percent(accuracy = 0.1)(floor(sum(oh_chr$rural_voters)/sum(oh_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "orange",
  value = label_percent(accuracy = 0.1)(floor(sum(oh_chr$female_voters)/sum(oh_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "tertiary",
  value = label_percent(accuracy = 0.1)(floor(sum(wi_chr$rural_voters)/sum(wi_chr$county_population)))
)
```
...
list(
  #icon = "clipboard2-pulse",
  color = "orange",
  value = label_percent(accuracy = 0.1)(floor(sum(wi_chr$female_voters)/sum(wi_chr$county_population)))
)
```
...
chr_2024|>
  ...
  arrange(fipscode)|>
  datatable(
    colnames=c("fipscode","County Name","State","Percent Female Population","Percent Voter Turnout","Population",
               "Percent Rural Population","Majority Gender","Ruralness"),
